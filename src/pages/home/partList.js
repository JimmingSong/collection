            ...
            partData: [
                {
                    title: 'Part 01',
                    project: '罗欧罗意项目',
                    list: [{txt: 'ROOROY APP'}, {txt: 'ROOROY 企业站'}, {txt: 'ROOROY VIS'}, {txt: 'ROOROY H5'}]
                },
                {
                    title: 'Part 02',
                    project: '善诊项目',
                    list: [{txt: '善诊 APP'}, {txt: '善诊 企业站'}, {txt: '善诊 H5'}]
                },
                {
                    title: 'Part 03',
                    project: '其他',
                    list: [{txt: 'AKZEN APP'}, {txt: 'AKZEN 企业站'}, {txt: '海报'}, {txt: '产品包装'}, {txt: '图标等'}]
                },
            ]
        }
    };
                ...
                <div>
                    ...
                    <div>
                        {partData && partData.length && partData.map((item, index) => <div key={index} className='part-box'>
                            ...
                            <div>{item.list.map((det, dex) => <div key={dex} className='pd-5-0px'>
                                <span>{dex + 1}. {det.txt}</span></div>)}</div>
                        </div>)}
                    </div>
                </div>
                <div>
